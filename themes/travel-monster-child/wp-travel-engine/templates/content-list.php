...
<?php
if ( $rev = ft_get_trip_review_data( get_the_ID() ) ) : ?>
    <span class="trip-review">
        &#11088; <?php echo esc_html( $rev['rating'] ); ?>
        <span class="trip-review-count">(<?php echo intval( $rev['count'] ); ?>)</span>
    </span>
<?php endif; ?>
