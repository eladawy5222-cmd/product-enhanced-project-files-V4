<?php
/**
 * Travel_Monster Customizer Select Control.
 *
...
if ( ! class_exists( 'Travel_Monster_Select_Control' ) ) {
	...
	class Travel_Monster_Select_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'travel-monster-selectize', get_template_directory_uri() . '/inc/js/selectize.js', array( 'jquery' ) ); // for multi select
			wp_enqueue_script( 'travel-monster-select', get_template_directory_uri() . '/inc/custom-controls/select/select.min.js', array( 'jquery', 'travel-monster-selectize' ), false, true ); // for multi select
		}
