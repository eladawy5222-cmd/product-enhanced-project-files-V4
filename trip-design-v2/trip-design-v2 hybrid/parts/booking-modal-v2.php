...
<div class="fts-bm-overlay fts-bm-tabs-mode" id="fts-booking-modal">
  <div class="fts-bm-container">
    ...
    <div class="fts-bm-trust-bar">
      <?php
      $trust_items = array();
      if ( ! empty( $bm_facts['duration'] ) ) {
        $trust_items[] = '<span class="fts-bm-trust-item"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#22c55e" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>' . esc_html( $bm_facts['duration'] ) . '</span>';
      }
      if ( ! empty( $bm_facts['meeting_point'] ) ) {
        $trust_items[] = '<span class="fts-bm-trust-item"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#22c55e" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-4.35 7-11a7 7 0 0 0-14 0c0 6.65 7 11 7 11z"/><circle cx="12" cy="10" r="2"/></svg>' . esc_html( $bm_facts['meeting_point'] ) . '</span>';
      }
      if ( ! empty( $bm_facts['group_size'] ) ) {
        $trust_items[] = '<span class="fts-bm-trust-item"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#22c55e" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>' . esc_html( $bm_facts['group_size'] ) . '</span>';
      }
      $trust_items[] = '<span class="fts-bm-trust-item fts-bm-trust-secure"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/></svg>' . esc_html__( 'Secure Payment', 'fts' ) . '</span>';

      foreach ( $trust_items as $ti => $html ) {
        if ( $ti > 0 ) echo '<span class="fts-bm-trust-sep">&middot;</span>';
        echo $html;
      }
      ?>
    </div>
      ...
      <div class="fts-bm-step locked" data-step="4" id="fts-bm-step-4">
        ...
        <div class="fts-bm-step-body">
          ...
          <div class="fts-bm-trust-footer">
            ...
            <?php if ( ! empty( $bm_facts['duration'] ) ) : ?>
            <span class="fts-bm-footer-sep">&middot;</span>
            <span>
              ...
              <?php echo esc_html( $bm_facts['duration'] ); ?>
            </span>
            <?php endif; ?>
          </div>
