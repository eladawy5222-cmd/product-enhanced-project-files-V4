...
function publishPackagesSafe_(tripId, wpTripId) {
   try {
     ...
     try {
       var incRecsPkg = findRecordsByLinkedId_('TripIncludes Improvement With AI', 'Trip', tripId);
       var excRecsPkg = findRecordsByLinkedId_('TripExcludes Improvement With AI', 'Trip', tripId);
    ...
    function processPackage(pkgFields, linkedPrices) {
       ...
       if (pkgFields.excerpt) {
         payload.excerpt = pub_sanitizePackageCopyAgainstTruth_(String(pkgFields.excerpt), entranceTruthPkg, incTextPkg, excTextPkg);
       }
       if (pkgFields.content_html) {
         payload.content_html = pub_sanitizePackageCopyAgainstTruth_(String(pkgFields.content_html), entranceTruthPkg, incTextPkg, excTextPkg);
       }
